<!doctype html>
	...
	<head>
		<meta charset="utf-8">
		<title>facturation non paye</title>
	...
	<nav>
		<nav class="navbar navbar-light bg-light">
			...
			<form class="form-inline">
				<button class="btn btn-outline-success" type="button"><a href='index.php?controle=entreprise&action=accueilEntrep&idE=<?php echo($idE); ?>' title='action facturation du controleur facturation'>
				Accueil</a></button>
			</form>
		</nav>
	</nav>
